...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// GD3D11 LOCAL EDITS (see XeGTAO.hlsl for the engine-side entry points that drive this):
//   1. XeGTAO_ClampDepth: `#ifdef XE_GTAO_USE_HALF_FLOAT_PRECISION` -> `#if`. Upstream bug: the macro is
//      defined-to-0 in the FP32 configuration (which is the one this backend uses — see XeGTAO.hlsl), and
//      `#ifdef` is true for "defined as 0", so FP32 depths were being clamped to the fp16 ceiling of 65504.
//      That matters here more than in Intel's sample: Gothic's view depths routinely exceed 65504 units.
// Everything else is Intel's 1.30 release verbatim.
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
#if XE_GTAO_USE_HALF_FLOAT_PRECISION     // GD3D11 local edit: was #ifdef — see the header note
