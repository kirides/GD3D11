//--------------------------------------------------------------------------------------
// Compute Shader - Bloom Downsample (D3D12 port of Shaders/CS_PFX_Bloom_Downsample.hlsl)
...
// used to build the rest of the bloom pyramid. Identical math to the D3D11 shader — kept
// as a separate D3D12/ file since D3D12ShaderBackend only looks under shaders/D3D12/.
//--------------------------------------------------------------------------------------
