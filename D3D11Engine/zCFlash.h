...
public:
    ...
    static void Hook() {
        HookedFunctions::OriginalFunctions.original_zCFlashSetVisualUsedBy.Detour( Hooked_SetVisualUsedBy  );
        HookedFunctions::OriginalFunctions.original_zCFlashDestructor.Detour( Hooked_Destructor  );
    }
