...
XRESULT GothicAPI::SaveMenuSettings( const std::string& file ) {
    ...
    WritePrivateProfileStringA( "General", "DrawWeaponTrails", std::to_string( s.DrawWeaponTrails ? TRUE : FALSE ).c_str(), ini.c_str() );
...
XRESULT GothicAPI::LoadMenuSettings( const std::string& file ) {
    ...
    s.DrawWeaponTrails = s.HbaoSettings.Enabled = GetPrivateProfileBoolA( "General", "DrawWeaponTrails", defaultRendererSettings.DrawWeaponTrails, ini );
