...
void RenderDisplayTab( ImGuiShim& shim, GothicRendererSettings& settings ) {
    ...
    constexpr ListItem<GothicRendererSettings::E_GraphicsAPI> graphicsApis[] = {
        ...
        { "Vulkan (experimental)", GothicRendererSettings::GRAPHICS_API_VULKAN, "Work in progress: renders the game without GPU culling or FSR 3; expect missing effects. Falls back to Direct3D 11 without Vulkan 1.3." },
    };
