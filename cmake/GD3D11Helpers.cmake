...
function(gd3d11_collect_vcxproj_sources vcxproj out_var)
  ...
  foreach(_line IN LISTS _compile_lines)
    ...
    cmake_path(SET _source NORMALIZE "${_source}")
...
function(gd3d11_apply_windows_sdk_includes target_name)
  ...
  if(NOT _env_include STREQUAL "")
    cmake_path(SET _env_include NORMALIZE "${_env_include}")
  ...
  cmake_path(SET _sdk_dir NORMALIZE "${_sdk_dir}")

  set(_sdk_version "$ENV{WindowsSDKVersion}")
  cmake_path(SET _sdk_version NORMALIZE "${_sdk_version}")
...
function(gd3d11_apply_common_compile_settings target_name)
  ...
  elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang|GNU")
    ...
    if(GD3D11_SIMD STREQUAL "AVX")
      target_compile_options(${target_name} PRIVATE -mavx -mpopcnt)
    elseif(GD3D11_SIMD STREQUAL "AVX2")
      target_compile_options(${target_name} PRIVATE -mavx2 -mfma -mf16c -mbmi -mbmi2 -mlzcnt -mmovbe -mpopcnt)
    else()
